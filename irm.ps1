...
powershell -Command "Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/IBRHUB/Aurora/refs/heads/main/AuroraModules/UACbypasses.bat' -OutFile \"$env:temp\UACbypasses.bat\"; Invoke-WebRequest -Uri 'https://github.com/IBRHUB/Aurora/releases/download/0.3/Aurora.cmd' -OutFile \"$env:temp\Aurora.cmd\"; Start-Process -FilePath 'cmd.exe' -ArgumentList '/c %temp%\UACbypasses.bat cmd.exe /c \"%temp%\Aurora.cmd\"'"